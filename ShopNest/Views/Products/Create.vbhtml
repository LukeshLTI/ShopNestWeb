...
@Using (Html.BeginForm("Create", "Products", FormMethod.Post, htmlAttributes:=New With {.enctype = "multipart/form-data"}))
    @Html.AntiForgeryToken()
    @<div Class="">
        <div Class="page-title">
            <div Class="title_left">
                <h6>Package Product</h6>
            </div>
                    ...
                    <form id="demo-form2" data-parsley-validate Class="form-horizontal form-label-left">
                        ...
                        <div Class="item form-group">
                            <Label Class="col-form-label col-md-3 col-sm-3 label-align" for="ProductName">
                                <h6>Product Name <span class="required text-danger">*</span></h6> 
                            </Label>
                        ...
                        <div Class="item form-group">
                            <Label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align"><h6>Category <span class="required text-danger">*</span></h6></Label>
                            <div Class="col-md-6 col-sm-6">
                        ...
                        <div Class="item form-group">
                            <Label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align"><h6>Sub Category <span class="required text-danger">*</span></h6></Label>
                            <div Class="col-md-6 col-sm-6 ">
                        ...
                        <div Class="item form-group">
                            <Label Class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
                                <h6> Description <span class="required text-danger">*</span></h6>
                            </Label>
                            <div Class="col-md-6 col-sm-6 ">
                                <textarea Class="form-control" rows="3" cols="4" name="Description"></textarea>
                                @*@Html.TextAreaFor(Function(model) model.Description, New With {.htmlAttributes = New With {.class = "form-control", .rows = "3", .cols = "8"}})*@
                                @Html.ValidationMessageFor(Function(model) model.Description, "", New With {.class = "text-danger"})
                            </div>
                        </div>
                        <div Class="item form-group">
                            <Label Class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
                                <h6>Version <span class="required text-danger">*</span></h6>
                            </Label>
                            <div Class="col-md-6 col-sm-6 ">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">
                                <h6>Launch Date <span class="required text-danger">*</span></h6>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                                <input class="date-picker form-control"  name="LaunchDate" placeholder="dd-mm-yyyy" type="text" required="required" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                                <script>
                        ...
                        <div Class="item form-group">
                            <Label Class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
                                <h6>Price <span class="required text-danger">*</span></h6>
                            </Label>
                            <div Class="col-md-6 col-sm-6 ">
                               ...
                               @* <div class="btn-group m-3">
                                    <a class="btn" title="Insert picture (or just drag &amp; drop)" id="pictureBtn"><i class="fa fa-picture-o"></i></a>&nbsp;&nbsp;<h6>Upload Image</h6>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div Class="item form-group">
                            <Label Class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
                                <h6>Upload Image <span class="required text-danger">*</span></h6>
                            </Label>
                            <div Class="col-md-6 col-sm-6 ">
                               <div class="btn-group m-3">                                   
                                    <input type="file" name="file" data-role="magic-overlay" data-target="#pictureBtn" data-edit="insertImage" accept=".jpg,.png" title="Choose Image">
